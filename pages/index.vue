<template>
  <div>
    <section class="hero bg-linear-dark text-white py-20">
      <div class="container mx-auto px-4">
        <h1 class="text-5xl font-bold mb-4">Welcome to My Portfolio</h1>
        <p class="text-xl mb-8">I'm a passionate developer creating amazing web experiences.</p>
        <NuxtLink to="/projects" class="bg-linear-blue text-white px-6 py-3 rounded-lg hover:bg-opacity-90 transition duration-300">
          View My Projects
        </NuxtLink>
      </div>
    </section>
    ...
    <section class="projects py-16">
      <div class="container mx-auto px-4">
        ...
        <div v-else-if="loading" class="text-white mb-4">Loading projects...</div>
    ...
    <section class="skills bg-linear-dark py-16">
      <div class="container mx-auto px-4">
